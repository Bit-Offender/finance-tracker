              ...
              <NavigationMenuList className='flex justify-around'>
                <NavigationMenuItem className='px-5'>
                  <NavigationMenuLink asChild>
                    { isSignedIn ? (
                      <Link href='/dashboard'>
                        <Button className='hover:bg-white hover:text-black transition-all duration-300 rounded-full group/button'>Go to Dashboard<ArrowRight  className='group-hover/button:translate-x-1 transition-all duration-300'/></Button>
                      </Link>
