          ...
          <div className='ml-6 md:w-1/2 flex-col items-center justify-center'>
            ...
            { isSignedIn ? (
              <Link href='/dashboard' className='flex justify-center md:justify-start'>
                <Button variant='outline' className='w-auto pb-3 h-[61px] text-2xl font-semibold tracking-widest transition-all duration-300 rounded-full bg-[#439A86] border-0'>Go to dashboard</Button>
              </Link>
            ) : (
